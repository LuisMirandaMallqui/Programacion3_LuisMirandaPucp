...
public class ReportesStocksDTO {
    ...
    public String toString(){
        String cadena = "";
        cadena = cadena.concat(this.saldoInicial.toString());
        cadena = cadena.concat(", ");
        cadena = cadena.concat(this.entradas.toString());
        cadena = cadena.concat(", ");
        cadena = cadena.concat(this.salidas.toString());
        cadena = cadena.concat(", ");
        cadena = cadena.concat(this.saldoFinal.toString());
        return cadena;
    }
